...
--
-- Name: liked_posts; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE "public"."liked_posts" OWNER TO "supabase_admin";

--
-- Name: liked_posts_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--

ALTER TABLE "public"."liked_posts" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."liked_posts_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: liked_posts liked_posts_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."liked_posts"
    ADD CONSTRAINT "liked_posts_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."posts"
    ADD CONSTRAINT "posts_pkey" PRIMARY KEY ("id", "post_id");


--
-- Name: posts posts_post_id_key; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: liked_posts liked_posts_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."liked_posts"
    ADD CONSTRAINT "liked_posts_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("post_id");


--
-- Name: liked_posts liked_posts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY "public"."liked_posts"
    ADD CONSTRAINT "liked_posts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id");
...
--
-- Name: liked_posts Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Enable insert for authenticated users only" ON "public"."liked_posts" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: liked_posts Enable read access for all users; Type: POLICY; Schema: public; Owner: supabase_admin
--

CREATE POLICY "Enable read access for all users" ON "public"."liked_posts" FOR SELECT USING (true);
...
--
-- Name: liked_posts; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: TABLE "liked_posts"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE "public"."liked_posts" TO "postgres";
GRANT ALL ON TABLE "public"."liked_posts" TO "anon";
GRANT ALL ON TABLE "public"."liked_posts" TO "authenticated";
GRANT ALL ON TABLE "public"."liked_posts" TO "service_role";


--
-- Name: SEQUENCE "liked_posts_id_seq"; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE "public"."liked_posts_id_seq" TO "postgres";
GRANT ALL ON SEQUENCE "public"."liked_posts_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."liked_posts_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."liked_posts_id_seq" TO "service_role";
